...
export const INVENTORY: Record<string, Row> = {
    ...
    'RxList.reduce':         row('reduceOperator.spec.ts(示例级差分)', 'reduceOperator.spec.ts(示例级差分)', 'collectionLedgerBurndown2.spec.ts', 'collectionLedgerBurndown2.spec.ts', 'collectionLedgerBurndown.spec.ts(batch 尾追加/混合)', 'reduceOperator.spec.ts(僵尸检查)', 'collectionLedgerBurndown2.spec.ts(NaN/-0 透传)'),
